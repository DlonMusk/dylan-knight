...
function Experience() {
  return (
    <motion.div
            ...
            <h3 className='absolute top-24 md:top-40 uppercase tracking-[15px] text-xl md:text-2xl'>Experience</h3>
